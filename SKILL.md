...
- **README.md**: Create or update a concise README alongside SKILL.md. For new skills, always generate README.md. For existing skills, update README.md whenever SKILL.md behavior, trigger conditions, workflow, bundled resources, evals, or usage instructions change.
...
├── README.md (required for user-created skills)
...
Every newly created skill must include a concise README.md next to SKILL.md. The README should be short enough for GitHub browsing and include:

- What the skill does
- When to use it and when not to use it
- The core workflow or interaction pattern
